...
def answer_question(pdf_text, question):
    ...
    response = client.chat.completions.create(
        ...
        messages=[
            {"role": "system", "content": "You are an AI assistant answering questions based on your knowledge base. Do not state the reference to any section of the knowledge base when answering the user. If the user asks something outside of the PDF topic, use your general knowledge."},
